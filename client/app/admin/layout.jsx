...
import { adminPageItems } from '@/public/assests';
...
const layout = ({ children }) => {
    ...
    return (
        <div className='h-screen md:max-w-lg mx-auto w-full md:flex bg-linear-to-r from-zinc-100 via-zinc-50 to-zinc-50 overflow-hidden'>
            ...
            <div className={`flex-1 p-5 mt-18 h-screen overflow-y-auto [overflow-style:none] scrollbar-none bg-white`}>
                {children}
            </div>
            ...
            <nav className="shadow-md md:max-w-lg mx-auto shadow-zinc-600/10 backdrop-blur-xl bg-green-50 fixed top-0  w-full flex justify-between items-center p-5">
                <a href='/admin' className={`relative`}>
                    <Image
                        src={logo}
                        alt="Logo"
